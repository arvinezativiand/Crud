...
namespace Crud.Infrastructure.Migrations
{
    ...
    [Migration("20250403131807_Id-corrected2")]
    partial class Idcorrected2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crud.Domain.Entities.RPouyaAdmin", b =>
                {
                    ...
                    b.OwnsOne("Crud.Domain.Entities.JsonFile", "Data", b1 =>
                        {
                            ...
                            b1.ToTable("RPouyaFile");

                            b1.ToJson("Data");

                            b1.WithOwner()
                                .HasForeignKey("RPouyaFileId");
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Crud.Domain.Entities.RPouyaAdmin", null)
                        .WithMany()
